...
@Component({
  selector: 'app-arn-wise-aum-report',
  standalone: true,
  ...
  templateUrl: './arn-wise-aum-report.component.html',
  styleUrl: './arn-wise-aum-report.component.scss'
})
export class ArnWiseAumReportComponent implements OnInit {
